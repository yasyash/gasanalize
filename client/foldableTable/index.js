...
export default (ReactTable) => {
    ...
    const wrapper = class RTFoldableTable extends React.Component {
        ...
        componentDidMount() {
            ...
            //New props "folded" has been added 
            //for indicating folded state of column
            columns.map((col, index) => {
                if (col.folded) {           //If we need folded state in rended component we should call onClick handler.
