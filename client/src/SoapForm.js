...
import { getSoap, updateSoap, deleteSoap, insertSoap } from './actions/adminActions';
...
class SoapForm extends React.Component {
    ...
    handleAdd() {
        ...
        this.props.insertSoap({ address, username, pwd, periods })
            .then(resp => {
                this.setState({ openDialog: false });
...
export default connect(null, {
    getSoap, updateSoap, deleteSoap, insertSoap
